...
OBJS := \
	...
	$(obj).target/$(TARGET)/cppsrc/macos/windowmacos.o
...
$(builddir)/wm.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(builddir)/wm.node: LIBS := $(LIBS)
$(builddir)/wm.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/wm.node: TOOLSET := $(TOOLSET)
$(builddir)/wm.node: $(OBJS) $(builddir)/nothing.a FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/wm.node
# Add target alias
.PHONY: wm
wm: $(builddir)/wm.node
...
.PHONY: wm.node
wm.node: $(builddir)/wm.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/wm.node
